...
class GoogleVisionSafeSearch implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $i->adult = $likelihoodNames[$adult];
        $i->medical = $likelihoodNames[$medical];
        $i->spoof = $likelihoodNames[$spoof];
        $i->violence = $likelihoodNames[$violence];
        $i->racy = $likelihoodNames[$racy];
        $i->save();
